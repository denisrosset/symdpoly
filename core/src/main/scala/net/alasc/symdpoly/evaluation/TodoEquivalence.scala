...
trait TodoEquivalence[F <: free.MonoidDef with Singleton] {
...
object TodoEquivalence {
  def fullAdjoint[F <: free.MonoidDef with Singleton:Witness.Aux]: TodoEquivalence[F] = new FullAdjointEquivalence[F]
  def cyclic[F <: free.MonoidDef with Singleton:Witness.Aux](predicate: OpPredicate[F]): TodoEquivalence[F] = new CyclicEquivalence[F](predicate)
  def transpose[F <: free.MonoidDef with Singleton:Witness.Aux](predicate: OpPredicate[F]): TodoEquivalence[F] = new TransposeEquivalence[F](predicate)
  ...
  class FullAdjointEquivalence[F <: free.MonoidDef with Singleton](implicit wF: Witness.Aux[F]) extends TodoEquivalence[F] {
    def F: F = wF.value
...
abstract class PredicateEquivalence[F <: free.MonoidDef with Singleton](predicate: OpPredicate[F])(implicit wF: Witness.Aux[F]) extends TodoEquivalence[F] {
  def F: F = wF.value
